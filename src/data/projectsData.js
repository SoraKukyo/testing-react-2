...
import nine from "../assets/png/odoo3.png";
import ten from "../assets/png/flipflash.png";
import eleven from "../assets/png/onlychat.png";

export const projectsData = [
  {
    id: 1,
    projectName: "Odoo ERP System",
    projectDesc:
      "This project aims to migrate a legacy erp software to odoo erp system 13.0 and migrations of over a million record has to be done.",
    tags: ["XML", "Javascript", "Python", "Postgresql"],
    code: "https://gitlab.com/phalla.boramey19/odoo-13-upgrade",
    demo: "",
    image: nine,
  },
  {
    id: 2,
    projectName: "FlipFlash",
    projectDesc:
    ...
    tags: ["Vue JS", "Electron JS", "Node JS", "MongoDB"],
    code: "https://github.com/rachanapich/FlipFlash/tree/flipflash-backend",
    demo: "",
    image: ten,
  },
  {
